...
export default function Rubriques() {
  ...
  return (
    <section className='mt-3 rubriques mx-5'>
      <div className='row w-100 '>
        <div className="col-12 col-md-6 col-lg-4">
          <div onClick={() => NavigateToRubrique()} className="card border-0 bg-transparent text-light h-100">
            ...
            <div className='card-body d-flex flex-column'>
              <h5 className="text-center fw-bold"><u>Protection de l'enfance</u></h5>
              <p>
              ...
              <p className='mt-auto text-center'>
                <button className='btn'>Découvrir le Foyer</button>
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="col-12 col-md-6 col-lg-4">
          <div onClick={() => NavigateToRubrique()} className="card border-0 bg-transparent text-light h-100">
            ...
            <div className='card-body d-flex flex-column'>
              <h5 className="text-center fw-bold"><u>Education et scolarité</u></h5>
              <p>
              ...
              <p className='mt-auto text-center'>
                <button className='btn'>Découvrir le Plamier</button>
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="col-12 col-md-6 col-lg-4">
          <div onClick={() => NavigateToRubrique()} className="card border-0 bg-transparent text-light h-100">
            ...
            <div className='card-body d-flex flex-column'>
              <h5 className="text-center fw-bold"><u>Formation et insertion porfessionnlle</u></h5>
              <p>
              ...
              <p className='mt-auto text-center'>
                <button className='btn'>Découvrir le CFI</button>
              </p>
            </div>
          </div>
        </div>
