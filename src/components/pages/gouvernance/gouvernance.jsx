...
const Gouvernance = () => {
  ...
  const members = [
    { name: 'Ratibe Hind', role: 'Membre Fondateur', position: 'Secrétaire général', avatar: profil2 },
    { name: 'Hamroudi Fatima Zahra', role: 'Fondatrice-Présidente', avatar: profil },
    { name: 'Ratibe Abdelmoula', role: 'Membre Fondateur', position: 'Vice-président', avatar: me },
    { name: 'LALAMI Driss', role: 'Membre Fondateur', position: 'Trésorier Adjoint', avatar: me },
    { name: 'Sefrioui Mouji Salim', role: 'Membre Fondateur', position: 'Trésorier général', avatar: profil2 },
    { name: 'Jamal Lahjouji Mohamed', role: 'Membre Fondateur', position: 'Vice-président', avatar: profil },
    { name: 'Anas Guennoun', role: 'Vice-président', avatar: profil },
    { name: 'Mesbahi Zhor', position: 'Secrétaire Général Adjoint', avatar: me },
